...
const Testimonial = () => {
  return (
    <section className='mx-4 text-center '>
        <h1 className='Testimonial_heading flex justify-center dark:text-white'>Student About CodeBook</h1>
        <div className="grid mb-8 rounded-lg border border-gray-200 shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2 my-5 ">
            <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-t-lg border-b border-gray-200 md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800">
                <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-white ">
